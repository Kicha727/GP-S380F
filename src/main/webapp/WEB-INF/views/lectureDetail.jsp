        ...
        <div class="card mb-5">
            <div class="card-body p-4">
                ...
                <div class="lecture-meta d-flex flex-wrap align-items-center">
                    <span class="me-4"><i class="fas fa-calendar-alt"></i> <fmt:formatDate value="${lecture.createdAt}" pattern="MMMM d, yyyy" /></span>
                    <span class="me-4"><i class="fas fa-clock"></i> <fmt:formatDate value="${lecture.createdAt}" pattern="h:mm a" /></span>
                    ...
                    <div class="comment-card">
                        <div class="comment-header">
                            ...
                            <div class="comment-date">
                                <i class="fas fa-clock me-1"></i> <fmt:formatDate value="${comment.createdAt}" pattern="MMMM d, yyyy 'at' h:mm a" />
                            </div>
                        </div>
